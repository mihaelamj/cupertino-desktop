...
/// Drives the AppKit desktop framework browser through the Page Object Model. Selecting a
/// framework must load its document into the reader (not leave the empty "Select a
/// framework" state). The same page object backs the mobile and SwiftUI targets; only the
