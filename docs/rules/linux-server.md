...
Operational rules for XCTemplateDSL code that runs on Linux in production: HTTP client, logging, database, crypto, signals, resources, POSIX interop, file I/O, and Docker CI.
...
public final class XCTemplateDSLloader: @unchecked Sendable {
...
let baseProducts: [Product] = [
    .singleTargetLibrary("XCTemplateDSL"),
