...
SwiftUI view rules for the planned XCTemplateDSL native editor: purely presentational, performant, accessible, reusable. Views observe ViewModels but contain ZERO business logic.
